...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    user_permissions = models.ManyToManyField(Permission, blank=True, related_name='user_permissions', verbose_name='user permissions')
    ...
    def get_group_permissions(self, obj=None):
        ...
        if self.is_superuser:
            return permissions
        return permissions.filter(content_type__model='group')
